    ...
    return (
        <div className="lg:flex bg-white rounded-2xl">
            ...
            <div className="flex flex-col justify-between p-6 lg:mx-6">
                ...
                <p className="my-8 text-base lg:text-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam tincidunt arcu diam.Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
