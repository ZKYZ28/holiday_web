        ...
        <div className="page-size flex w-full justify-center items-center background ">
            <div className="lg:w-4/6 w-11/12 h-1/2 p-16 bg-white rounded-2xl box-shadow">
                ...
                <div className="flex flex-col h-1/2">
                    ...
                    <div>
                        <h1 className="lg:text-8xl text-5xl font-bold lg:mb-0 mb-4">Holiday<Point/></h1>
                    </div>
                    <p className="mt-3.5 lg:text-3xl text-lg font-bold">Rejoingnez nos ??? membres actifs en cliquant juste ici !</p>
                </div>
